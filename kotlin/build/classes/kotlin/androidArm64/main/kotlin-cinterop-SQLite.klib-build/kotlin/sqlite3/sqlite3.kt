...
@CStruct("struct { struct { int p0[10]; } p0; }")
...
@CStruct("struct { long p0; int p1; void* p2; void* p3; void* p4; }")
...
class sqlite3_api_routines(rawPtr: NativePtr) : CStructVar(rawPtr) {
    ...
    var vmprintf: CPointer<CFunction<(CPointer<ByteVar>?, CValue<va_list>) -> CPointer<ByteVar>?>>?
        get() = memberAt<CPointerVar<CFunction<(CPointer<ByteVar>?, CValue<va_list>) -> CPointer<ByteVar>?>>>(912).value
        set(value) { memberAt<CPointerVar<CFunction<(CPointer<ByteVar>?, CValue<va_list>) -> CPointer<ByteVar>?>>>(912).value = value }
    ...
    var xvsnprintf: CPointer<CFunction<(Int, CPointer<ByteVar>?, CPointer<ByteVar>?, CValue<va_list>) -> CPointer<ByteVar>?>>?
        get() = memberAt<CPointerVar<CFunction<(Int, CPointer<ByteVar>?, CPointer<ByteVar>?, CValue<va_list>) -> CPointer<ByteVar>?>>>(1520).value
        set(value) { memberAt<CPointerVar<CFunction<(Int, CPointer<ByteVar>?, CPointer<ByteVar>?, CValue<va_list>) -> CPointer<ByteVar>?>>>(1520).value = value }
    ...
    var str_vappendf: CPointer<CFunction<(CPointer<sqlite3_str>?, CPointer<ByteVar>?, CValue<va_list>) -> Unit>>?
        get() = memberAt<CPointerVar<CFunction<(CPointer<sqlite3_str>?, CPointer<ByteVar>?, CValue<va_list>) -> Unit>>>(1848).value
        set(value) { memberAt<CPointerVar<CFunction<(CPointer<sqlite3_str>?, CPointer<ByteVar>?, CValue<va_list>) -> Unit>>>(1848).value = value }
...
fun sqlite3_vmprintf(@CCall.CString arg0: String?, arg1: CValue<va_list>): CPointer<ByteVar>? = throw UnsupportedOperationException()
...
@Deprecated("Unable to import this declaration", level = DeprecationLevel.ERROR)
fun sqlite3_vsnprintf(arg0: Int, arg1: CValuesRef<ByteVar>?, @CCall.CString arg2: String?, arg3: CValue<va_list>): CPointer<ByteVar>? = throw UnsupportedOperationException()
...
@Deprecated("Unable to import this declaration", level = DeprecationLevel.ERROR)
fun sqlite3_str_vappendf(arg0: CValuesRef<sqlite3_str>?, @CCall.CString zFormat: String?, arg2: CValue<va_list>): Unit = throw UnsupportedOperationException()
...
@Deprecated("Unable to import this declaration", level = DeprecationLevel.ERROR)
fun sqlite3VMPrintf(arg0: CValuesRef<sqlite3>?, @CCall.CString arg1: String?, arg2: CValue<va_list>): CPointer<ByteVar>? = throw UnsupportedOperationException()
...
@Deprecated("Unable to import this declaration", level = DeprecationLevel.ERROR)
fun renderLogMsg(iErrCode: Int, @CCall.CString zFormat: String?, ap: CValue<va_list>): Unit = throw UnsupportedOperationException()
...
val sqlite3CtypeMap: CArrayPointer<UByteVar>
    get() = interpretCPointer<UByteVar>(kniBridge8())!!

val sqlite3Config: Sqlite3Config
    get() = interpretPointed<Sqlite3Config>(kniBridge9())

val sqlite3BuiltinFunctions: FuncDefHash
    get() = interpretPointed<FuncDefHash>(kniBridge10())

val sqlite3IntTokens: CArrayPointer<Token>
    get() = interpretCPointer<Token>(kniBridge11())!!

var sqlite3PendingByte: Int
    get() = kniBridge12()
    set(value) { kniBridge13(value) }

val sqlite3OpcodeProperty: CArrayPointer<UByteVar>
    get() = interpretCPointer<UByteVar>(kniBridge14())!!

val sqlite3StrBINARY: CArrayPointer<ByteVar>
    get() = interpretCPointer<ByteVar>(kniBridge15())!!

val sqlite3Stat: sqlite3StatType
    get() = interpretPointed<sqlite3StatType>(kniBridge16())

val statMutex: CArrayPointer<ByteVar>
    get() = interpretCPointer<ByteVar>(kniBridge17())!!

val aXformType: CArrayPointer<anonymousStruct22>
    get() = interpretCPointer<anonymousStruct22>(kniBridge18())!!

var vfsList: CPointer<sqlite3_vfs>?
    get() = interpretCPointer<sqlite3_vfs>(kniBridge19())
    set(value) { kniBridge20(value.rawValue) }

val sqlite3Hooks: BenignMallocHooks
    get() = interpretPointed<BenignMallocHooks>(kniBridge21())

val mem0: Mem0Global
    get() = interpretPointed<Mem0Global>(kniBridge22())

val aDigits: CArrayPointer<ByteVar>
    get() = interpretCPointer<ByteVar>(kniBridge23())!!

val aPrefix: CArrayPointer<ByteVar>
    get() = interpretCPointer<ByteVar>(kniBridge24())!!

val fmtinfo: CArrayPointer<et_info>
    get() = interpretCPointer<et_info>(kniBridge25())!!

val sqlite3OomStr: sqlite3_str
    get() = interpretPointed<sqlite3_str>(kniBridge26())

val sqlite3Prng: sqlite3PrngType
    get() = interpretPointed<sqlite3PrngType>(kniBridge27())

val sqlite3SavedPrng: sqlite3PrngType
    get() = interpretPointed<sqlite3PrngType>(kniBridge28())

val sqlite3Utf8Trans1: CArrayPointer<UByteVar>
    get() = interpretCPointer<UByteVar>(kniBridge29())!!

var randomnessPid: pid_t
    get() = kniBridge30()
    set(value) { kniBridge31(value) }

val aSyscall: CArrayPointer<unix_syscall>
    get() = interpretCPointer<unix_syscall>(kniBridge32())!!

var unixBigLock: CPointer<sqlite3_mutex>?
    get() = interpretCPointer<sqlite3_mutex>(kniBridge33())
    set(value) { kniBridge34(value.rawValue) }

var inodeList: CPointer<unixInodeInfo>?
    get() = interpretCPointer<unixInodeInfo>(kniBridge35())
    set(value) { kniBridge36(value.rawValue) }

val posixIoMethods: sqlite3_io_methods
    get() = interpretPointed<sqlite3_io_methods>(kniBridge37())

val posixIoFinder: CPointer<CFunction<(CPointer<ByteVar>?, CPointer<unixFile>?) -> CPointer<sqlite3_io_methods>?>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, CPointer<unixFile>?) -> CPointer<sqlite3_io_methods>?>>(kniBridge38())

val nolockIoMethods: sqlite3_io_methods
    get() = interpretPointed<sqlite3_io_methods>(kniBridge39())

val nolockIoFinder: CPointer<CFunction<(CPointer<ByteVar>?, CPointer<unixFile>?) -> CPointer<sqlite3_io_methods>?>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, CPointer<unixFile>?) -> CPointer<sqlite3_io_methods>?>>(kniBridge40())

val dotlockIoMethods: sqlite3_io_methods
    get() = interpretPointed<sqlite3_io_methods>(kniBridge41())

val dotlockIoFinder: CPointer<CFunction<(CPointer<ByteVar>?, CPointer<unixFile>?) -> CPointer<sqlite3_io_methods>?>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, CPointer<unixFile>?) -> CPointer<sqlite3_io_methods>?>>(kniBridge42())

val pcache1_g: PCacheGlobal
    get() = interpretPointed<PCacheGlobal>(kniBridge43())

val aJournalMagic: CArrayPointer<UByteVar>
    get() = interpretCPointer<UByteVar>(kniBridge44())!!

val zMagicHeader: CArrayPointer<ByteVar>
    get() = interpretCPointer<ByteVar>(kniBridge45())!!

var sqlite3SharedCacheList: CPointer<BtShared>?
    get() = interpretCPointer<BtShared>(kniBridge46())
    set(value) { kniBridge47(value.rawValue) }

val sqlite3SmallTypeSizes: CArrayPointer<u8Var>
    get() = interpretCPointer<u8Var>(kniBridge48())!!
...
val statGetFuncdef: FuncDef
    get() = interpretPointed<FuncDef>(kniBridge52())
...
val likeInfoAlt: compareInfo
    get() = interpretPointed<compareInfo>(kniBridge55())

val hexdigits: CArrayPointer<ByteVar>
    get() = interpretCPointer<ByteVar>(kniBridge56())!!

val sqlite3Apis: sqlite3_api_routines
    get() = interpretPointed<sqlite3_api_routines>(kniBridge57())

val sqlite3Autoext: sqlite3AutoExtList
    get() = interpretPointed<sqlite3AutoExtList>(kniBridge58())

val pragCName: CArrayPointer<CPointerVar<ByteVar>>
    get() = interpretCPointer<CPointerVar<ByteVar>>(kniBridge59())!!

val aPragmaName: CArrayPointer<PragmaName>
    get() = interpretCPointer<PragmaName>(kniBridge60())!!

val pragmaVtabModule: sqlite3_module
    get() = interpretPointed<sqlite3_module>(kniBridge61())
...
val yy_shift_ofst: CArrayPointer<UShortVar>
    get() = interpretCPointer<UShortVar>(kniBridge75())!!

val yy_reduce_ofst: CArrayPointer<ShortVar>
    get() = interpretCPointer<ShortVar>(kniBridge76())!!
...
const val SQLITE_BYTEORDER: Int = 0
...
val SQLITE_BIGENDIAN: Int
    get() = kniBridge91()

val SQLITE_LITTLEENDIAN: Int
    get() = kniBridge92()

val SQLITE_UTF16NATIVE: Int
    get() = kniBridge93()

val SQLITE_DYNAMIC: sqlite3_destructor_type?
    get() = interpretCPointer<CFunction<(COpaquePointer?) -> Unit>>(kniBridge94())
...
val sqlite3StrNICmp: CPointer<CFunction<(CPointer<ByteVar>?, CPointer<ByteVar>?, Int) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, CPointer<ByteVar>?, Int) -> Int>>(kniBridge102())

val getVarint: CPointer<CFunction<(CPointer<UByteVar>?, CPointer<u64Var>?) -> u8>>?
    get() = interpretCPointer<CFunction<(CPointer<UByteVar>?, CPointer<u64Var>?) -> u8>>(kniBridge103())

val putVarint: CPointer<CFunction<(CPointer<UByteVar>?, u64) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<UByteVar>?, u64) -> Int>>(kniBridge104())

val vfsList_: CPointer<sqlite3_vfs>?
    get() = interpretCPointer<sqlite3_vfs>(kniBridge105())

val UpperToLower: CPointer<UByteVar>?
    get() = interpretCPointer<UByteVar>(kniBridge106())

val threadid: pthread_t
    get() = kniBridge107()

val lseek: CPointer<CFunction<(Int, off64_t, Int) -> off64_t>>?
    get() = interpretCPointer<CFunction<(Int, off64_t, Int) -> off64_t>>(kniBridge108())

val osOpen: CPointer<CFunction<(CPointer<ByteVar>?, Int, Int) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, Int, Int) -> Int>>(kniBridge109())

val osClose: CPointer<CFunction<(Int) -> Int>>?
    get() = interpretCPointer<CFunction<(Int) -> Int>>(kniBridge110())

val osAccess: CPointer<CFunction<(CPointer<ByteVar>?, Int) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, Int) -> Int>>(kniBridge111())

val osGetcwd: CPointer<CFunction<(CPointer<ByteVar>?, size_t) -> CPointer<ByteVar>?>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, size_t) -> CPointer<ByteVar>?>>(kniBridge112())

val osStat: CPointer<CFunction<(CPointer<ByteVar>?, CPointer<stat>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, CPointer<stat>?) -> Int>>(kniBridge113())

val osFstat: CPointer<CFunction<(Int, CPointer<stat>?) -> Int>>?
    get() = interpretCPointer<CFunction<(Int, CPointer<stat>?) -> Int>>(kniBridge114())

val osFtruncate: CPointer<CFunction<(Int, off_t) -> Int>>?
    get() = interpretCPointer<CFunction<(Int, off_t) -> Int>>(kniBridge115())

val osFcntl: COpaquePointer?
    get() = interpretCPointer<COpaque>(kniBridge116())

val osRead: CPointer<CFunction<(Int, COpaquePointer?, size_t) -> ssize_t>>?
    get() = interpretCPointer<CFunction<(Int, COpaquePointer?, size_t) -> ssize_t>>(kniBridge117())

val osPread: CPointer<CFunction<(Int, COpaquePointer?, size_t, off_t) -> ssize_t>>?
    get() = interpretCPointer<CFunction<(Int, COpaquePointer?, size_t, off_t) -> ssize_t>>(kniBridge118())

val osPread64: CPointer<CFunction<(Int, COpaquePointer?, size_t, off64_t) -> ssize_t>>?
    get() = interpretCPointer<CFunction<(Int, COpaquePointer?, size_t, off64_t) -> ssize_t>>(kniBridge119())

val osWrite: CPointer<CFunction<(Int, COpaquePointer?, size_t) -> ssize_t>>?
    get() = interpretCPointer<CFunction<(Int, COpaquePointer?, size_t) -> ssize_t>>(kniBridge120())

val osPwrite: CPointer<CFunction<(Int, COpaquePointer?, size_t, off_t) -> ssize_t>>?
    get() = interpretCPointer<CFunction<(Int, COpaquePointer?, size_t, off_t) -> ssize_t>>(kniBridge121())

val osPwrite64: CPointer<CFunction<(Int, COpaquePointer?, size_t, off64_t) -> ssize_t>>?
    get() = interpretCPointer<CFunction<(Int, COpaquePointer?, size_t, off64_t) -> ssize_t>>(kniBridge122())

val osFchmod: CPointer<CFunction<(Int, mode_t) -> Int>>?
    get() = interpretCPointer<CFunction<(Int, mode_t) -> Int>>(kniBridge123())

val osFallocate: CPointer<CFunction<(Int, off_t, off_t) -> Int>>?
    get() = interpretCPointer<CFunction<(Int, off_t, off_t) -> Int>>(kniBridge124())

val osUnlink: CPointer<CFunction<(CPointer<ByteVar>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?) -> Int>>(kniBridge125())

val osOpenDirectory: CPointer<CFunction<(CPointer<ByteVar>?, CPointer<IntVar>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, CPointer<IntVar>?) -> Int>>(kniBridge126())

val osMkdir: CPointer<CFunction<(CPointer<ByteVar>?, mode_t) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, mode_t) -> Int>>(kniBridge127())

val osRmdir: CPointer<CFunction<(CPointer<ByteVar>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?) -> Int>>(kniBridge128())

val osFchown: CPointer<CFunction<(Int, uid_t, gid_t) -> Int>>?
    get() = interpretCPointer<CFunction<(Int, uid_t, gid_t) -> Int>>(kniBridge129())

val osGeteuid: CPointer<CFunction<() -> uid_t>>?
    get() = interpretCPointer<CFunction<() -> uid_t>>(kniBridge130())

val osMmap: CPointer<CFunction<(COpaquePointer?, size_t, Int, Int, Int, off_t) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(COpaquePointer?, size_t, Int, Int, Int, off_t) -> COpaquePointer?>>(kniBridge131())

val osMunmap: CPointer<CFunction<(COpaquePointer?, size_t) -> Int>>?
    get() = interpretCPointer<CFunction<(COpaquePointer?, size_t) -> Int>>(kniBridge132())

val osMremap: COpaquePointer?
    get() = interpretCPointer<COpaque>(kniBridge133())

val osGetpagesize: CPointer<CFunction<() -> Int>>?
    get() = interpretCPointer<CFunction<() -> Int>>(kniBridge134())

val osReadlink: CPointer<CFunction<(CPointer<ByteVar>?, CPointer<ByteVar>?, size_t) -> ssize_t>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, CPointer<ByteVar>?, size_t) -> ssize_t>>(kniBridge135())

val osLstat: CPointer<CFunction<(CPointer<ByteVar>?, CPointer<stat>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?, CPointer<stat>?) -> Int>>(kniBridge136())

val osIoctl: COpaquePointer?
    get() = interpretCPointer<COpaque>(kniBridge137())

val fdatasync: CPointer<CFunction<(Int) -> Int>>?
    get() = interpretCPointer<CFunction<(Int) -> Int>>(kniBridge138())

val get4byte: CPointer<CFunction<(CPointer<u8Var>?) -> u32>>?
    get() = interpretCPointer<CFunction<(CPointer<u8Var>?) -> u32>>(kniBridge139())

val put4byte: CPointer<CFunction<(CPointer<u8Var>?, u32) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<u8Var>?, u32) -> Unit>>(kniBridge140())

val noopFunc: CPointer<CFunction<(CPointer<sqlite3_context>?, Int, CPointer<CPointerVar<sqlite3_value>>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<sqlite3_context>?, Int, CPointer<CPointerVar<sqlite3_value>>?) -> Unit>>(kniBridge141())
...
private external fun kniBridge6(): Int
...
private external fun kniBridge13(p0: Int): Unit
...
private external fun kniBridge30(): Int
@SymbolName("sqlite3_kniBridge31")
private external fun kniBridge31(p0: Int): Unit
...
private external fun kniBridge99(): Int
@SymbolName("sqlite3_kniBridge100")
private external fun kniBridge100(): Int
...
private external fun kniBridge107(): Long
